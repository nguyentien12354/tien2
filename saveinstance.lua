...
local ClassPropertiesBlacklist =
	{ GuiObject = { "Transparency" }, Instance = { "Parent" }, BasePart = { "BrickColor" }, Instance = { "UnionOperation" }, Instance = { "meshId" }, Instance = {"Attachment"}} -- GuiObject.Transparency is almost always 1 meaning everything will be transparent, Instance.Parent is useless in xml (no idea about binary), BasePart.BrickColor hurts other Color3 properties
