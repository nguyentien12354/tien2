...
local ClassPropertiesBlacklist =
	{ GuiObject = { "Transparency" }, Instance = { "Parent" }, BasePart = { "BrickColor" } , Instance = {"Attachment"}, Instance = {"Bone"}} -- GuiObject.Transparency is almost always 1 meaning everything will be transparent, Instance.Parent is useless in xml (no idea about binary), BasePart.BrickColor hurts other Color3 properties
...
local function synsaveinstance(CustomOptions)
	...
	local OPTIONS = {
		...
		-- MaxThreads = 3
		RemovePlayerCharacters = false, -- If enabled, player characters will not be saved.
		SavePlayers = true,
